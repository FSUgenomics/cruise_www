...
RUN echo "if [ ! ls -A /usr/local/bin ]; then git clone https://github.com/fsugenomics/cruise_scripts /usr/local/bin && update_www" > /usr/bin/update && chmod +x /usr/bin/update
